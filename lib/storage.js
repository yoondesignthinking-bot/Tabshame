...
(function () {
  ...
  const DEFAULT_SETTINGS = {
    ...
    //   "full" — persona poster stacked above the shortcut grids
    //   "lite" — same single-column stack, but shortcut grids placed
    //            ABOVE the persona (persona becomes a full-width card
    //            below). Persona is an add-on, not replaced — single
    //            alignment axis preserved.
